						...
						<div class="right-side">
							<div class="row sub-columns">
								<div class="col-lg-4 col-md-6 sub-one-left pr-lg-4">
									...
									<p class="pr-lg-4">Our main focus is here waste managment, Waste Sorting, Company Collibration , we can collect that particular issential and provided to StartUp copmany .</p>
									<div class="columns-2">
										<ul class="social">
								...
								<div class="col-lg-4 col-md-6 sub-one-left">
									...
									<div class="mid-footer-gd sub-two-right">
										...
										<ul>
											<li><a href="donations.php"><span class="fa fa-angle-double-right mr-2"></span>Waste Pick up</a>
											</li>
											<li><a href="donations.php"><span class="fa fa-angle-double-right mr-2"></span>E- managementwaste</a>
											</li>
											<li><a href="donate.php"><span class="fa fa-angle-double-right mr-2"></span>Garbage Management</a>
											</li>
										...
										<ul>
											<li><a href="register.php"><span
														class="fa fa-angle-double-right mr-2"></span>Awareness program</a>
											</li>
				...
				<div class="container">
					<div class="copyright-footer">
						<div class="columns text-lg-left">
							<p>© 2024 . All rights reserved | Designed by Yogesh & Vaibhav <a
									href="home.php">SmartBin</a></p>
						</div>
