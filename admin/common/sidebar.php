            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <!-- <li><a href="m_donation.php"><i class="fa fa-angle-right"></i> Payement Deatils</a></li> -->
                  <li><a href="donate.php"><i class="fa fa-angle-right"></i> view complaints</a></li>
                </ul>
              </li>
              <li class="treeview">
              ...
              <li class="treeview">
                <a href="m_user.php">
                <i class="fa fa-laptop"></i> <span>Manage Company</span>
                </a>
              </li>
              <li class="treeview">
                <a href="m_event.php">
                <i class="fa fa-laptop"></i> <span><b>view Requirements</b></span>
                </a>
              </li>
              <li class="treeview">
                <a href="resources.php">
                <i class="fa fa-laptop"></i> <span><b>view Resource Availability</b></span>
                </a>
              </li>
              <li class="treeview">
                <a href="v_i.php">
